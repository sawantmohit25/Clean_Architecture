...
void main(){
  ...
  group('getConcreteNumberTrivia', (){
    ...
    runTestsOnline((){
      test('should return remote data when the call to data is successful',()async{
        //arrange
      ...
      test('should cache the data locally when the call to data is successful',()async{
        //arrange
        when(mockRemoteDataSource.getConcreteNumberTrivia(any)).thenAnswer((_)async => tNumberTriviaModel);
        //act
        final result=await repository.getConcreteNumberTrivia(tNumber);
      ...
      test('should return server failure when the call to data is unsuccessful',()async{
        //arrange
    ...
    runTestsOffine((){
      ...
      test(
          'should return cached failure when there is no cached data present',()async{
        //arrange
